  ...
  return (
    <div className="hero_container relative w-full">
      <img
        ...
        style={{ minHeight: isMobile ? '375px' : '550px' }}
      />
      <div className="hero__text absolute top-0 flex items-center justify-center flex-col w-full h-full bg-black bg-opacity-30 p-2.5">
